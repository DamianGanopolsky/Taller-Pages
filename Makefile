...
fuentes = client_main.cpp server_main.cpp Client_manager.cpp Socket.cpp Thread.cpp File.cpp Parser.cpp Comando_Get.cpp Comando_Post.cpp Comando.cpp ThClient.cpp
